...
def combine_data(data_100KHz, data_2000KHz):
    # Merge on timestamp and label
    combined_data = pd.merge(data_100KHz, data_2000KHz, on=['timestamp', 'label'], suffixes=('_100KHz', '_2000KHz'))
    return combined_data
